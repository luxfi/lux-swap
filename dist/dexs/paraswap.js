...
export const decodeCalldata = (tx) => {
    ...
    switch (result.name) {
        case "simpleSwap": {
            ...
            const [fromToken, toToken, fromAmount, toAmount, expectedAmount, callees, exchangeData, startIndexes, values, beneficiary,] = data;
        ...
        case "multiSwap": {
            const [data] = result.args;
            const [fromToken, fromAmount, toAmount, expectedAmount, beneficiary, path,] = data;
